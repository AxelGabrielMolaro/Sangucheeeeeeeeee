...
<body>
	...
	<div class="contariner-fluid">
		...
		<form:form modelAttribute="usuario" method="POST" action="/sitio-polo/buscarUsuario">
         ...
         <form:form modelAttribute="usuarioAModificar" method="POST" action="/sitio-polo/modificarUsuario2">
		 <div class="form-group">
 		   ...
 		   <div class="form-group">
            <label for="" class="label-control col-md-12">Apellido</label>
	         <div>
          ...
          <%--  <div class="form-group ocultar">
            <label for="" class="label-control col-md-12 ">Mail</label>
	         <div>
	           	
	         </div>
          </div> --%>
          <form:input path="mail" type="hidden" class="form-control"/>
          <form:input path="fechaDeNacimiento" type="hidden" class="form-control"/>
         <%--  <div class="form-group ocultar">
            <label for="" class="label-control col-md-12">Fecha de nacimiento</label>
	         <div>
	           	<form:input path="fechaDeNacimiento" type="date" class="form-control"/>
	         </div>
          </div> --%>
           <div class="form-group">
            <label for="" class="label-control col-md-12">contraseña</label>
	         <div>
          ...
          <div class="form-group col-md-12">
              <input type="submit" class="btn btn-success form-control submitAgrgarIngredienteASanguche" value="Modificar usuario">
              <div class="alert-warning">
                Error
              </div>
          </div>
